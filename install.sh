...
sudo apt update
sudo apt install thunderbird i3 i3blocks openvpn htop insomnia pavucontrol gpick curl feh zsh tmux vim snapd timeshift shotcut pinta darktable gnome-screenshot ubuntu-make signal-desktop git arandr glmark2 hardinfo
